 ...
 * 					-1 buffer full
 */
int32_t usQueue_push(volatile struct usQueue *c, const uint16_t data)
{
	int32_t err = 0;
	uint32_t next = 0;
 ...
 * 					-2 not unique
 */
int32_t usQueue_push_unique(volatile struct usQueue *c, const uint16_t data)
{
	int32_t err = 0;
	uint32_t i = 0;
	int32_t i_x = 0;
 ...
 * 					-1 queue empty
 */
int32_t usQueue_pop(volatile struct usQueue *c, uint16_t *pData)
{
	int32_t err = 0;
 ...
 */
void usQueue_reset(volatile struct usQueue *c)
{
	c->head = 0;
	c->tail = 0;
}
 ...
 */
uint32_t usQueue_messages_waiting(volatile struct usQueue *c)
{
	uint32_t tmp;
